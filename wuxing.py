...
SHENSHA_TIANDE_TABLE = {
    '寅': ['壬', '丁'], '卯': ['巳', '申'], '辰': ['壬', '丁'], '巳': ['丙', '辛'], '午': ['寅', '亥'], '未': ['甲', '己'],
    '申': ['戊', '癸'], '酉': ['寅', '亥'], '戌': ['甲', '己'], '亥': ['乙', '庚'], '子': ['巳', '申'], '丑': ['乙', '庚']
}

SHENSHA_YUEDE_TABLE = {('子', '申', '辰'): '壬', ('亥', '卯', '未'): '甲', ('寅', '午', '戌'): '丙', ('巳', '酉', '丑'): '庚'}

SHENSHA_SANQI_TABLE = [('甲', '戊', '庚'), ('乙', '丙', '丁'), ('壬', '癸', '辛')]

SHENSHA_TIANYIGUIREN_TABLE = {
    ('甲', '戊', '庚'): ['丑', '未'], ('乙', '己'): ['子', '申'], ('丙', '丁'): ['亥', '酉'],
    ('壬', '癸'): ['巳', '卯'], ('辛'): ['寅', '午']
}

SHENSHA_TIANSHE_TABLE = {('寅', '卯', '辰'): '戊寅', ('巳', '午', '未'): '甲午',
                         ('申', '酉', '戌'): '戊申', ('亥', '子', '丑'): '甲子'}

SHENSHA_SHIGANLU_TABLE = {'甲': '寅', '乙': '卯', '丙': '巳', '戊': '巳', '丁': '午',
                          '己': '午', '庚': '申', '辛': '酉', '壬': '亥', '癸': '子'}

SHENSHA_WENCHANG_TABLE = {'甲': '巳', '乙': '午', '丙': '申', '戊': '申', '丁': '酉',
                          '己': '酉', '庚': '亥', '辛': '子', '壬': '寅', '癸': '卯'}

SHENSHA_JIANGXING_TABLE = {('子', '申', '辰'): '子', ('亥', '卯', '未'): '卯', ('寅', '午', '戌'): '午', ('巳', '酉', '丑'): '酉'}

SHENSHA_HUAGAI_TABLE = {('子', '申', '辰'): '辰', ('亥', '卯', '未'): '未', ('寅', '午', '戌'): '戌', ('巳', '酉', '丑'): '丑'}

SHENSHA_YIMA_TABLE = {('子', '申', '辰'): '寅', ('亥', '卯', '未'): '巳', ('寅', '午', '戌'): '申', ('巳', '酉', '丑'): '亥'}

SHENSHA_YANGREN_TABLE = {'甲': '卯', '乙': '辰', '丙': '午', '戊': '午', '丁': '未',
                         '己': '未', '庚': '酉', '辛': '戌', '壬': '子', '癸': '丑'}

SHENSHA_TAOHUA_TABLE = {('子', '申', '辰'): '酉', ('亥', '卯', '未'): '子', ('寅', '午', '戌'): '卯', ('巳', '酉', '丑'): '午'}

SHENSHA_GUCHENGUXIU_TABLE = {('寅', '卯', '辰'): ['巳', '丑'], ('巳', '午', '未'): ['申', '辰'],
                             ('申', '酉', '戌'): ['亥', '未'], ('亥', '子', '丑'): ['寅', '戌']}

SHENSHA_WANGSHEN_TABLE = {('子', '申', '辰'): '亥', ('亥', '卯', '未'): '寅', ('寅', '午', '戌'): '巳', ('巳', '酉', '丑'): '申'}

SHENSHA_LIUJIAKONGWANG_TABLE = {('甲子', '乙丑', '丙寅', '丁卯', '戊辰', '己巳', '庚午', '辛未', '壬申', '癸酉'): ['戌', '亥'],
...
SHENSHA_SHIEDABAI_TABLE = {'庚戌': '甲辰', '辛亥': '乙巳', '壬寅': '丙申', '癸巳': '丁亥', '甲戌': '庚辰',
